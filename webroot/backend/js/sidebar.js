jQuery(function(){
    ...
    if(jQuery(this).width() < 1024) {
        ...
        jQuery('.sidebar-container').removeClass('span2').addClass('span2');
        jQuery('.body-container').removeClass('span10').addClass('span10');
		console.log('hi');
...
/*
// Removed on 10th Feb 2016: Replaced with CSS changes 
jQuery(window).load(function(){
    if(jQuery('.sidebar').hasClass('lefticon')){
        jQuery('.leftmenu ul li ul').css({left:'238px'});
    }else{
